...
--SELECT P.NAME, B.TITLE FROM SAWITZKI_PUBLISHERS AS P JOIN SAWITZKI_BOOKS AS B ON P.ID=B.PUBLISHER_ID;
--SELECT P.NAME, B.TITLE FROM SAWITZKI_PUBLISHERS AS P FULL JOIN SAWITZKI_BOOKS AS B ON P.ID=B.PUBLISHER_ID;
--SELECT P.NAME, B.TITLE FROM SAWITZKI_PUBLISHERS AS P LEFT JOIN SAWITZKI_BOOKS AS B ON P.ID=B.PUBLISHER_ID;
--SELECT P.NAME, B.TITLE FROM SAWITZKI_PUBLISHERS AS P RIGHT JOIN SAWITZKI_BOOKS AS B ON P.ID=B.PUBLISHER_ID;
-- SELECT * FROM SAWITZKI_BOOKS_AUTHORS
--SELECT B.TITLE, A.FIRSTNAME+' ' + A.LASTNAME AS 'author name' FROM SAWITZKI_BOOKS AS B JOIN SAWITZKI_BOOKS_AUTHORS AS BA ON B.ISBN=BA.ISBN JOIN SAWITZKI_AUTHORS AS A ON A.ID=BA.AUTHOR_ID WHERE A.LASTNAME LIKE 'PAUSE%'
--SELECT AVG(B.PRICE) FROM SAWITZKI_BOOKS AS B JOIN SAWITZKI_BOOKS_AUTHORS AS BA ON B.ISBN=BA.ISBN JOIN SAWITZKI_AUTHORS AS A ON A.ID=BA.AUTHOR_ID WHERE A.LASTNAME LIKE 'PAUSE%'
--SELECT COUNT(B.ISBN) FROM SAWITZKI_BOOKS AS B JOIN SAWITZKI_BOOKS_AUTHORS AS BA ON B.ISBN=BA.ISBN JOIN SAWITZKI_AUTHORS AS A ON A.ID=BA.AUTHOR_ID WHERE A.LASTNAME LIKE 'PAUSE%'

--SELECT COUNT(*) AS COUNT, A.LASTNAME FROM SAWITZKI_BOOKS AS B JOIN SAWITZKI_BOOKS_AUTHORS AS BA ON B.ISBN=BA.ISBN JOIN SAWITZKI_AUTHORS AS A ON A.ID=BA.AUTHOR_ID GROUP BY A.LASTNAME HAVING A.LASTNAME='Mustermann'
--SELECT COUNT(B.ISBN) AS COUNT, A.LASTNAME, B.ISBN FROM SAWITZKI_BOOKS AS B JOIN SAWITZKI_BOOKS_AUTHORS AS BA ON B.ISBN=BA.ISBN JOIN SAWITZKI_AUTHORS AS A ON A.ID=BA.AUTHOR_ID GROUP BY A.LASTNAME, B.ISBN
--Nested Group
-- SELECT COUNT(*), COUNT FROM (SELECT COUNT(*) as COUNT FROM SAWITZKI_BOOKS AS B JOIN SAWITZKI_BOOKS_AUTHORS AS BA ON B.ISBN=BA.ISBN JOIN SAWITZKI_AUTHORS AS A ON A.ID=BA.AUTHOR_ID GROUP BY A.LASTNAME) AS R GROUP BY COUNT

-- SELECT * FROM SAWITZKI_BOOKS WHERE PRICE > 6.66
SELECT * FROM SAWITZKI_SCHOOL_BOOKS
SELECT * FROM SAWITZKI_SPECIALIST_BOOKS

SELECT * FROM SAWITZKI_ALL_BOOKS
