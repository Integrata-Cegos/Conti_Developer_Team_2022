...
SELECT B.TITLE, A.FIRSTNAME+' ' + A.LASTNAME FROM SAWITZKI_BOOKS AS B JOIN SAWITZKI_BOOKS_AUTHORS AS BA ON B.ISBN=BA.ISBN JOIN SAWITZKI_AUTHORS AS A ON A.ID=BA.AUTHOR_ID WHERE A.LASTNAME LIKE 'PAUSE%'
...
SELECT COUNT(*) FROM SAWITZKI_BOOKS AS B JOIN SAWITZKI_BOOKS_AUTHORS AS BA ON B.ISBN=BA.ISBN JOIN SAWITZKI_AUTHORS AS A ON A.ID=BA.AUTHOR_ID WHERE A.LASTNAME LIKE 'PAUSE%'
