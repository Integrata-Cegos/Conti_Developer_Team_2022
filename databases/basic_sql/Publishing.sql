...
--SELECT ISBN, TITLE, PRICE, dbo.SAWITZKI_CATEGORIZE_PRICE(PRICE) AS CATEGORY FROM SAWITZKI_BOOKS;
SELECT ISBN, TITLE, PRICE FROM SAWITZKI_BOOKS WHERE dbo.SAWITZKI_CATEGORIZE_PRICE(PRICE) = 'cheap'